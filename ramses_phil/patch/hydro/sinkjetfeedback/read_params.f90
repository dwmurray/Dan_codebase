subroutine read_params
  ...
  !--------------------------------------------------
  namelist/run_params/clumpfind,cosmo,pic,sink,stir,jet_feedback,lightcone,poisson,hydro,rt,verbose,debug &
       & ,nrestart,ncontrol,nstepmax,nsubcycle,nremap,ordering &
       & ,bisec_tol,static,geom,overload,cost_weighting,aton,fine_level_output
  ...
  namelist/poisson_params/epsilon,gravity_type,gravity_params &
       & ,cg_levelmin,cic_levelmax,read_grav_on_restart,G_factor
