subroutine backup_sink(filename)
  ...
  if(nsink>0)then
     ...
     write(ilun)rsink(1:nsinkmax) ! Write sink radius
     deallocate(xdp)
     allocate(ii(1:nsink))
     do i=1,nsink
        ii(i)=idsink(i)
...
subroutine output_sink(filename)
  ...
  write(ilun,'(" ================================================================================================================================== ")')
  write(ilun,'("        Id       Mass(Msol)     R(Rsol)         x                y                z               vx               vy               vz      ")')
  write(ilun,'(" ================================================================================================================================== ")')
  ...
  do isink=1,nsink
     ...
     write(ilun,'(I10,8(2X,E15.7))')idsink(isink),msink(isink)*scale_m/2d33,rsink(isink)*scale_d/7d10,xsink(isink,1:ndim),vsink(isink,1:ndim)
  end do
  write(ilun,'(" ================================================================================================================================== ")')
  close(ilun)
