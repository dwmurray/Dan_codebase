module amr_parameters
  ...
  logical::stir    =.false.   ! Stirring activated
  logical::jet_feedback=.false. ! jet feedback 
  ...
  logical::fine_level_output=.true. ! fine level output
  ! Mesh parameters
  ...
  real(dp)::delta_tout=0,tend=0
  real(dp)::delta_aout=0,aend=0
