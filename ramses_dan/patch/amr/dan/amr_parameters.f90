!Modified 05/2019 by DWM to include P.Changs' turbulent stirring algorithm.
module amr_parameters
  ...
  logical::stir    =.false.   ! Enable P.Chang Stirring !DWM 05/2019
  logical::fine_level_output =.false. ! Fine level output !DWM 05/2019
