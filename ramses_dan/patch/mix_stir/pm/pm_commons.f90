module pm_commons
  ...
  real(dp),allocatable,dimension(:)  ::pfp      ! Birth pristine fraction - R. Sarmento - Jul 2014
  real(dp),allocatable,dimension(:)  ::z3p      ! The Z of the star particle due to POP III star nucleosynthesis. - R. Sarmento - Jan 2015
