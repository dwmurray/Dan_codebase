module hydro_parameters
  ...
  integer::ichem=6
  ! Rick Sarmento
  ! Created a new scalar to track the pristine gas fraction
  ! The flag that controls the instantiation of this var
  ! is prist_gas_fraction (which defaults to .false.)
  ! See read_hydro_params.
  ! If no other optional scalars are specified, iprist=6
  ! However, for each of the above that are used, iprist
  ! is incremented by one. e.g. - if imetal is used, then
  ! imetal = 6 and iprist=7
  integer::iprist=6
  ! Rick Sarmento - Mar 2014
  ! Created a new scalar to track the turbulent vel in
  ! each simulation cell. Note that to track iturbvel
  ! you need to track iprist too. This should be fixed in a
  ! later build
  integer::iturbvel=6
  ! Rick Sarmento - Jan 2015
  ! Tracking a new gas scalar. This is the fraction of the
  ! metals in the cell that has been generated by POP III
  ! stars (stars made of primordial gas)
  integer::iprimordz=6
