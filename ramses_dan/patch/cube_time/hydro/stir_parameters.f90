module stir_parameters
  ...
  logical :: pollute_initialized=.false.
  ...
  real(dp) :: stir_delta_t=1d10 ! DWM Timescale that acc field changes on. (s)
  integer  :: stir_tout=1 !Counter for updating acc field.
