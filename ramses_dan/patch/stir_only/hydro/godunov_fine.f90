...
subroutine godfine1(ind_grid,ncache,ilevel)
  ...
  use hydro_commons
  use poisson_commons
  use stir_parameters ! DWM Stirring 06/2019
  implicit none
  ...
  integer::nvarskip ! DWM Stirring 06/2019
  ...
  do idim=1,ndim
     ...
     nvarskip=0 ! DWM Stirring 06/2019
     if(stir) nvarskip=stir_nvar
     ! Conservative update of new state variables
     do ivar=1,nvar-nvarskip ! DWM Stirring ivar=1,nvar
