program part2birth
  ...
  real(kind=8),dimension(:),allocatable::bound_key,birth_date
  ...
  read(10,'(A13,I11)')dump,ncpu 
  read(10,'(A13,I11)')dump,ndim
  read(10,'(A13,I11)')dump,levelmin
  read(10,'(A13,I11)')dump,levelmax
  read(10,*)
  read(10,*)
  read(10,*)

  read(10,'(A13,E23.15)')dump,boxlen
  read(10,'(A13,E23.15)')dump,t
  read(10,'(A13,E23.15)')dump,aexp
  read(10,'(A13,E23.15)')dump,h0
  read(10,'(A13,E23.15)')dump,omega_m
  read(10,'(A13,E23.15)')dump,omega_l
  read(10,'(A13,E23.15)')dump,omega_k
  read(10,'(A13,E23.15)')dump,omega_b
  read(10,'(A13,E23.15)')dump,unit_l
  read(10,'(A13,E23.15)')dump,unit_d
  read(10,'(A13,E23.15)')dump,unit_t
